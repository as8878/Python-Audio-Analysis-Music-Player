...
# PREFERENCE_DB = os.path.sep.join([os.path.expanduser(r'~'), 'AppData', 'Local', 'Python Audio Analysis Music Player '])
# PREFERENCE_DB = os.path.join(os.path.expanduser(r'~'), 'AppData', 'Local', 'Python Audio Analysis Music Player ', 'settings')
